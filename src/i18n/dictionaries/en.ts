...
export const en: TranslationDictionary = {
  ...
  'parent.privacy.text':
    'The app has no ads or external links. Child profile and voice data are not uploaded; learning progress is stored in the cloud only with a parent’s permission.',
