...
function makePrepareTheHayScene(): Scene {
  ...
  const beats: VocabularyBeat[] = [
    ...
    },
    {
      ...
      practice: {
        ...
        successEn: 'The rabbit steadily chews the crisp hay.',
  ...
  const gentleRabbitVocabulary = vocabulary.find(
    item => item.word === 'gentle rabbit',
  )!;
  ...
  return {
    ...
    objects: [
      ...
      learningObject({
        id: `${sceneId}-gentle-rabbit-representative`,
        assetSource: sceneImageSource(sceneId, 'rabbit-standing-calm'),
        initialVisibility: 'hidden',
        isInteractive: false,
        learningScope: challengeScope,
        position: rect(54, 43, 40, 39),
        vocab: gentleRabbitVocabulary,
      }),
  ...
  const beats: VocabularyBeat[] = [
    ...
    },
    {
      ...
      practice: {
        ...
        successVi: 'Bát nước sạch đã ở ngay cạnh thỏ.',
        successEn: 'The clean water is now beside the thirsty rabbit.',
        failVi: 'Chạm bạn thỏ trắng nhé.',
        failEn: 'Tap the white rabbit.',
        successStateChanges: [
          sceneStateChanges.show(heroId),
    ...
    },
    {
      ...
      practice: {
        instructionVi: 'Chạm thỏ sau khi bạn uống xong nhé.',
        instructionEn: 'Tap the rabbit as it finishes drinking.',
        successVi: 'Thỏ uống xong và ngẩng đầu lên.',
        successEn: 'The rabbit finishes drinking and raises its head.',
        failVi: 'Chạm bạn thỏ trắng nhé.',
        failEn: 'Tap the white rabbit.',
        targetObjectId: heroId,
        successStateChanges: [
...
function makeRabbitSnackAndHopScene(): Scene {
  ...
  const beats: VocabularyBeat[] = [
    ...
    },
    {
      ...
      practice: {
        ...
        successVi: 'Thỏ gặm mẩu cà rốt nhỏ.',
        successEn: 'The rabbit nibbles the small treat.',
    ...
    },
    {
      ...
      practice: {
        instructionVi: 'Chạm thỏ để xem bạn bật nhảy nhé.',
        instructionEn: 'Tap the rabbit to watch it hop lightly.',
        successVi: 'Thỏ bật nhảy nhẹ nhàng quanh chỗ đứng.',
        successEn: 'The rabbit hops lightly around its spot.',
        failVi: 'Chạm bạn thỏ trắng nhé.',
        failEn: 'Tap the white rabbit.',
        successStateChanges: [
          sceneStateChanges.show(heroId),
    ...
    },
    {
      ...
      teachSuccessEn: 'Long ears extend high above the rabbit’s head.',
      ...
      practice: {
        ...
        successVi: 'Đôi tai dài của thỏ ngọ nguậy nhẹ nhàng.',
        successEn: 'The rabbit’s long ears wiggle gently.',
        failVi: 'Chạm bạn thỏ trắng nhé.',
        failEn: 'Tap the white rabbit.',
        targetObjectId: heroId,
      },
    },
    {
      ...
      teachSuccessEn: 'Fluffy fur looks soft, light, and puffy.',
      ...
      practice: {
        ...
        instructionEn: 'Tap the rabbit’s back very gently.',
        successVi: 'Bộ lông của bạn thỏ trông bông xốp và mềm.',
        successEn: 'The rabbit’s fluffy fur looks soft and light.',
        failVi: 'Chạm bạn thỏ trắng nhé.',
        failEn: 'Tap the white rabbit.',
        targetObjectId: heroId,
    ...
    },
    {
      ...
      speechPractice: 'optional',
      cueObjectId: heroId,
      teachVi: 'Chạm bạn thỏ đang nằm yên nhé.',
      teachEn: 'Tap the calm rabbit resting quietly.',
      teachSuccessEn: 'Calm means peaceful and not worried.',
      teachFailVi: 'Chạm bạn thỏ nằm yên dưới bàn tay nhé.',
      teachFailEn: 'Tap the rabbit resting quietly under the hand.',
      practice: {
        instructionVi: 'Chạm thỏ để bạn ngồi bình tĩnh nhé.',
        instructionEn: 'Tap the rabbit so it sits calmly.',
        successVi: 'Thỏ ngồi bình tĩnh sau khi được vuốt nhẹ.',
        successEn: 'The rabbit sits calmly after the gentle pet.',
        failVi: 'Chạm bạn thỏ trắng nhé.',
        failEn: 'Tap the white rabbit.',
        targetObjectId: heroId,
        successStateChanges: [sceneStateChanges.setVariant(heroId, 'pet-soft')],
    ...
    },
    {
      ...
      practice: {
        ...
        successVi: 'Thỏ nằm yên khi được vuốt nhẹ.',
    ...
    },
    {
      key: 'the-rabbit-hops',
      meaningVi: 'thỏ nhảy',
      word: 'the rabbit hops',
      tier: 'challenge',
      type: 'phrase',
      speechPractice: 'optional',
      cueAsset: 'rabbit-hopping-binky',
      cuePosition: leftCue,
      cueTouchArea: leftCueTouch,
      revealStateChanges: [sceneStateChanges.hide(heroId)],
      teachVi: 'Chạm bạn thỏ đang bật nhảy nhé.',
      teachEn: 'Tap the rabbit hopping in the air.',
      teachSuccessEn:
        'The rabbit hops means that the rabbit jumps with springy steps.',
      teachFailVi: 'Chạm bạn thỏ trắng đang nhảy nhé.',
      teachFailEn: 'Tap the white rabbit jumping in the air.',
      practice: {
        instructionVi: 'Chạm thỏ đang nhảy và nhớ rửa tay nhé.',
        instructionEn:
          'Tap the hopping rabbit and remember to wash your hands.',
        successVi: 'Thỏ bật nhảy và bé nhớ rửa tay sạch sẽ.',
        successEn: 'The rabbit hops and you remember to wash your hands.',
        failVi: 'Chạm bạn thỏ đang bật nhảy nhé.',
        failEn: 'Tap the hopping rabbit.',
        successStateChanges: [
          sceneStateChanges.show(heroId),
          sceneStateChanges.setVariant(heroId, 'hopping'),
        ],
  ...
  const vocabulary = makeBeatVocabulary(sceneId, beats);
  const calmVocabulary = vocabulary.find(item => item.word === 'calm')!;

  return {
    id: sceneId,
    titleVi: 'Món ăn nhỏ và thỏ bật nhảy',
    ...
    objects: [
      ...
      learningObject({
        id: `${sceneId}-calm-representative`,
        assetSource: sceneImageSource(sceneId, 'rabbit-pet-soft'),
        initialVisibility: 'hidden',
        isInteractive: false,
        learningScope: expandedScope,
        position: rect(54, 43, 40, 39),
        vocab: calmVocabulary,
      }),
      ...makeBeatObjects(sceneId, beats, vocabulary),
    ],
    steps: [
    ...
    completionReward: {
      stars: 3,
      messageVi: 'Thỏ đã ăn món nhỏ và bật nhảy nhẹ nhàng.',
      messageEn: 'The rabbit ate the small treat and hopped lightly.',
    },
  };
}
...
export const careForTheRabbitLesson: Lesson = {
  ...
  descriptionVi:
    'Bé chuẩn bị cỏ khô, thêm nước sạch và thưởng món nhỏ cho chú thỏ.',
  descriptionEn:
    'Prepare fresh hay, fill the bowl with clean water, and offer the rabbit a small treat.',
  thumbnailEmoji: '🐰',
