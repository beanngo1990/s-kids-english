...
function makeWelcomeTheKittenScene(): Scene {
  ...
  const beats: VocabularyBeat[] = [
    ...
    },
    {
      ...
      type: 'adjective',
      cueObjectId: heroId,
      teachVi: 'Chạm mèo con thân thiện đang dựng đuôi nhé.',
      teachEn: 'Tap the friendly kitten with its tail up.',
      teachSuccessEn: 'Friendly means kind and ready to be near others.',
      ...
      practice: {
        ...
        successVi: 'Mèo con thân thiện bước ra chào bé.',
        successEn: 'The friendly kitten comes out to greet you.',
        failVi: 'Chạm chú mèo đang dựng đuôi nhé.',
        failEn: 'Tap the kitten with its tail up.',
        targetObjectId: heroId,
        effects: [lessonEffects.sound('correct')],
      },
    },
    ...
    },
    {
      ...
      teachVi: 'Chạm chiếc đuôi đang dựng lên của mèo nhé.',
      teachEn: 'Tap the kitten with its tail up.',
      teachSuccessEn: 'Tail up means the kitten is holding its tail upright.',
      teachFailVi: 'Chạm chiếc đuôi vàng kem đang dựng lên nhé.',
      teachFailEn: 'Tap the upright golden tail.',
      practice: {
        instructionVi: 'Chạm chiếc đuôi dựng lên để nhận ra lời chào nhé.',
        instructionEn: 'Tap the upright tail used in a friendly greeting.',
        successVi: 'Chiếc đuôi dựng lên khi mèo con bước tới chào bé.',
        successEn: 'The kitten approaches with its tail held up.',
        failVi: 'Chạm chiếc đuôi đang dựng lên nhé.',
        failEn: 'Tap the upright tail.',
      },
    },
    {
      key: 'soft-fur',
      ...
      teachEn: 'Tap the kitten’s soft fur.',
      teachSuccessEn: 'Soft fur feels gentle to touch, not hard.',
    ...
    },
    {
      ...
      practice: {
        ...
        successVi: 'Mèo con nhẹ nhàng dụi đầu vào tay bé.',
        successEn: 'The kitten gently rubs its head against your hand.',
  ...
  const vocabulary = makeBeatVocabulary(sceneId, beats);
  const friendlyVocabulary = vocabulary.find(item => item.word === 'friendly')!;
  ...
  return {
    ...
    objects: [
      ...
      learningObject({
        id: `${sceneId}-friendly-representative`,
        assetSource: sceneImageSource(sceneId, 'kitten-approaching-hand'),
        initialVisibility: 'hidden',
        isInteractive: false,
        position: rect(31, 43, 39, 34),
        vocab: friendlyVocabulary,
      }),
      ...makeBeatObjects(sceneId, beats, vocabulary),
    ],
    steps: [
    ...
    completionReward: {
      stars: 3,
      messageVi: 'Mèo con đã tự đến gần và nhẹ nhàng dụi đầu.',
      messageEn: 'The kitten came close and gently rubbed its head.',
    },
  };
}
